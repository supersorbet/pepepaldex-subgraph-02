...
Contains data across all of pepedex. This entity tracks important things like total liquidity (in ETH and USD, see below), all time volume, transaction count, number of pairs and more.
...
Every transaction on pepedex is stored. Each transaction contains an array of mints, burns, and swaps that occured within it.
...
### Querying Aggregated Pepedex Data
